...
import { Conductor, EstadoConductor, getEstadoColor, getEstadoLabel } from "@/context/ConductorContext";
...
const ModalDetalleConductor: React.FC<ModalDetalleConductorProps> = ({
    ...
    const esPlanta = !!(conductor.cargo && conductor.fecha_ingreso && conductor.salario_base);
                ...
                {() => (
                    <>
                        <ModalHeader className="flex items-center justify-between">
                            ...
                            <Badge
                                className={`${estadoColor.badge} px-3 py-1`}
                            >
                                    ...
                                    <div className="flex-1 text-center md:text-left">
                                        ...
                                        <div className="flex flex-col md:flex-row md:items-center text-sm text-gray-500 space-y-1 md:space-y-0 md:space-x-4">
                                            <span className="flex items-center">
                                                ...
                                                {conductor.tipo_identificacion}: {conductor.numero_identificacion}
                                            </span>
                                            <span className="flex items-center">
                                        ...
                                        <div className="bg-gray-50 p-4 rounded-lg">
                                            ...
                                            <ul className="space-y-2">
                                                <li className="flex items-start">
                                                    ...
                                                    <span>{formatearFecha(conductor.fecha_nacimiento)}</span>
                                                </li>
                                                <li className="flex items-start">
                                                ...
                                                <li className="flex items-start">
                                                    ...
                                                    <span>{conductor.tipo_identificacion} {conductor.numero_identificacion}</span>
                                                </li>
                                            </ul>
                                        </div>
                                        ...
                                        <div className="bg-gray-50 p-4 rounded-lg">
                                            ...
                                            <ul className="space-y-2">
                                                <li className="flex items-start">
                                                    ...
                                                    <span>{conductor.licencia_conduccion || "No registrado"}</span>
                                                </li>
                                                <li className="flex items-start">
                                                    <span className="font-medium w-28">Categoría:</span>
                                                    <span>{conductor.categoria_licencia || "No registrada"}</span>
                                                </li>
                                                <li className="flex items-start">
                                                    <span className="font-medium w-28">Vencimiento:</span>
                                                    <span>{formatearFecha(conductor.vencimiento_licencia)}</span>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <div className="bg-gray-50 p-4 rounded-lg">
                                            ...
                                            <ul className="space-y-2">
                                                ...
                                                <li className="flex items-start">
                                                    <span className="font-medium w-28">Salario Base:</span>
                                                ...
                                                <li className="flex items-start">
                                                    ...
                                                    <span>{conductor.tipo_contrato || "No especificado"}</span>
                                                </li>
                                                <li className="flex items-start">
                                                ...
                                                <li className="flex items-start">
                                                    ...
                                                    <span className={`px-2 py-0.5 rounded-full text-xs ${estadoColor.badge}`}>
                                                        {getEstadoLabel(conductor.estado)}
                                                    </span>
                                                </li>
                                            </ul>
                                        ...
                                        <div className="bg-gray-50 p-4 rounded-lg">
                                            ...
                                            <ul className="space-y-2">
                                                ...
                                                <li className="flex items-start">
                                                    ...
                                                    <span>{conductor.fondo_pension || "No registrado"}</span>
                                                </li>
                                                <li className="flex items-start">
                                        ...
                                        <div className="bg-gray-50 p-4 rounded-lg">
                                            ...
                                            <ul className="space-y-2">
                                                {conductor.permisos && Object.entries(conductor.permisos).map(([clave, valor]) => (
                                                    <li key={clave} className="flex items-start">
                                                        <span className="font-medium w-28">
                                                            {clave === 'verViajes' ? 'Ver Viajes' :
                                                                clave === 'verMantenimientos' ? 'Ver Mantenimientos' :
                                                                    clave === 'verDocumentos' ? 'Ver Documentos' :
                                                                        clave === 'actualizarPerfil' ? 'Editar Perfil' : clave}:
                                                        </span>
                                                        <span className={`px-2 py-0.5 rounded-full text-xs ${valor ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}`}>
                                        ...
                                        <li className="flex items-start">
                                            ...
                                            <span>
                                                {conductor.ultimo_acceso
                                                    ? new Date(conductor.ultimo_acceso).toLocaleString('es-CO')
                                                    : "Nunca ha accedido"}
                                            </span>
                                        </li>
                                        <li className="flex items-start">
                                            ...
                                            <span>
                                                {conductor.createdAt
                                                    ? new Date(conductor.createdAt).toLocaleString('es-CO')
                                                    : "No disponible"}
                                            </span>
                                        </li>
                                        <li className="flex items-start">
                            ...
                            <div className="flex space-x-2">
                                ...
                                <Button
                                    ...
                                    onPress={() => {
                                        ...
                                        alert('Funcionalidad para descargar información del conductor');
                                    }}
                                >
                                    Descargar Info
                                </Button>
